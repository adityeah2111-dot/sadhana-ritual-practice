    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 lg:pt-24 overflow-hidden">
      ...
      <div className="container relative z-10 px-4 lg:px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <span className="inline-block px-4 py-1.5 text-xs uppercase tracking-[0.2em] text-muted-foreground bg-secondary rounded-full border border-border mb-8">
          ...
          <motion.h1
            ...
            className="text-display-md md:text-display-lg lg:text-display-xl font-semibold text-foreground mb-6"
          >
            Your daily practice.
            <br />
          ...
          >
            Sadhana is a ritual-based fitness system. No choices, no distractions. 
          ...
          >
            No ads. No social feeds. No vanity metrics.
          </motion.p>
        </div>
      </div>
